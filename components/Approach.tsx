    ...
    return (
        <section className={'w-full py-20'}>
            ...
            <h1 className={'font-bold text-4xl md:text-5xl text-center '}>
                <TextGenerateEffect numberOf={0} className={'text-center text-[40px] md:text-3xl lg:text-4xl'} words={`Jak Pracujemy`} />
            </h1>

            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
                <Card title="Planowanie & Strategia" icon={<AceternityIcon order={'Etap Pierwszy'} /> } description={'Zaczynamy od zagłębienia się w szczegóły projektu, aby lepiej zrozumieć Twoje potrzeby. Następnie przygotowujemy PLAN DZIAŁANIA'}>
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                        containerClassName="bg-emerald-900"
                    />
                </Card>
                <Card title="Realizacja & Aktualizacja Postępów" icon={<AceternityIcon order={'Etap Drugi'} />} description={"Gdy już ustalimy plan działania, zabieramy się do pracy. Jednocześnie regularnie konsultując postępy ustalnego wspólnie planu"}>
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card title="Efekt Końcowy" icon={<AceternityIcon order={'Etap Trzeci'} />} description={"Na końec dbamy o to aby założony przez nas plan przebiegł pomyślnie"}>
                    <CanvasRevealEffect
                        animationSpeed={3}
...
const Card = ({
    ...
    return (
        <div
            ...
            className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] h-[20rem] rounded-2xl  "
        >
